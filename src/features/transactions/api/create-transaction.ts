...
type Response = InferResponseType<typeof client.api.transactions.$post, 200>;
type Request = InferRequestType<typeof client.api.transactions.$post>['json'];
...
export default function createCreateTransactionClient(options: Options = {}) {
